...
def main():
    ...
    fig_info = "e_vs_delta"
    sim_info = "n20-delta0_0-q1-r0_04-K250_0-price1-cost0_5-noise1e-05-R_0" + \
    "lo250_0-R_0hi250_0-e_0lo0_0-e_0hi0_04-num_feedback50-p_discount0_5-nu" + \
    "m_steps1000" # copied from e_path
